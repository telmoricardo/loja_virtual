...
const Crud = () => {
    ...
    const [objetos, setObjetos] = useState(null);
    const [objeto, setObjeto] = useState<Demo.Estado>(emptyEstado);
    ...
    const deleteProduct = () => {
        let _products = (objetos as any)?.filter((val: any) => val.id !== product.id);
        setObjetos(_products);
        setDeleteProductDialog(false);
        setProduct(emptyProduct);
        toast.current?.show({
            severity: 'success',
    ...
    const deleteSelectedProducts = () => {
        let _products = (objetos as any)?.filter((val: any) => !(selectedProducts as any)?.includes(val));
        setObjetos(_products);
        setDeleteProductsDialog(false);
    ...
    const nomeBodyTemplate = (rowData: Demo.Estado) => {
        return (
            <>
    ...
    const regiaoBodyTemplate = (rowData: Demo.Estado) => {
        return (
            <>
    ...
    const capitalBodyTemplate = (rowData: Demo.Estado) => {
        return (
            <>
    ...
    const header = (
        <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
            ...
            <span className="block mt-2 md:mt-0 p-input-icon-left">
                ...
                <InputText type="search" onInput={(e) => setGlobalFilter(e.currentTarget.value)} placeholder="Pesquise..." />
            </span>
        </div>
    );
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    >
                        ...
                        <Column field="sigla" header="Sigla" body={siglaBodyTemplate} ></Column>                        
                        <Column field="regiao" header="Região" body={regiaoBodyTemplate} headerStyle={{ minWidth: '10rem' }}></Column>                        
                        <Column field="capital" header="Capital" body={capitalBodyTemplate} ></Column>
